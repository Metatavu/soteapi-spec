...
module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    'clean': {
      'jaxrs-spec-cruft': [
        'jaxrs-spec-generated/src/main/java/fi/metatavu/soteapi/server/RestApplication.java'
      ],
    ...
    'shell': {
      'jaxrs-spec-generate': {
        command : 'mv jaxrs-spec-generated/pom.xml jaxrs-spec-generated/pom.xml.before && ' +
          ...
          '-i ./swagger.yaml ' +
          '-l jaxrs-spec ' +
          '--api-package fi.metatavu.soteapi.server.rest ' +
          '--model-package fi.metatavu.soteapi.server.rest.model ' +
          '--group-id fi.metatavu.soteapi ' +
          '--artifact-id soteapi-spec ' +
    ...
    'javascript-package-update': {
      'javascript-package': {
        'fields': {
          ...
          "repository": {
            "type": "git",
            "url": "git://github.com/Metatavu/soteapi-client.git"
          },
          "license": "gpl-3.0"
        }
      }
