...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SoteapiClient.InternalServerError();
  });
  ...
  describe('InternalServerError', function() {
    it('should create an instance of InternalServerError', function() {
      ...
      //var instane = new SoteapiClient.InternalServerError();
      //expect(instance).to.be.a(SoteapiClient.InternalServerError);
    });
