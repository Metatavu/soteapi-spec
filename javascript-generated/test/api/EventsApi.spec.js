...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SoteapiClient.EventsApi();
  });
  ...
  describe('EventsApi', function() {
    describe('findEvent', function() {
      it('should call findEvent successfully', function(done) {
        //uncomment below and update the code to test findEvent
        //instance.findEvent(function(error) {
